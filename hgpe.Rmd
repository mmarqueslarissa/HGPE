...
dt_campos %>% 
ggplot(aes(x = Tempo.em.segundos, y = Número.de.votos, colour = Candidato, size =soma)) +
  geom_point()+
  geom_smooth(formula= y ~ x, colour= 'black', method='lm', span = 0.8,se=F, linetype = "dotted")+
  ...
  ylab("Número de votos") + xlab("Tempo em Segundos")+
  labs(title = "Tempo de Propaganda Eleitoral Gratuita e voto", col = NULL, fill = NULL)+
